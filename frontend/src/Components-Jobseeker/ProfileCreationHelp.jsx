    ...
    <>
      ...
      <div className="profilehelp-page">
        <div className="profilehelp-container">
          ...
          {/* Centered Flowchart Section */}
          <div className="profilehelp-hero-section">
            <svg viewBox="0 0 880 660" className="profilehelp-flowchart">
              <defs>
          ...
          {/* Profile Creation Summary - Now moved down */}
          <div className="profilehelp-summary-section">
            <div className="profilehelp-steps-container">
              <h2 className="profilehelp-summary-title">Profile Creation Summary</h2>
