...
export const EmployerDashboard = () => {
    ...
    // ✅ Fetch verification status when dashboard loads
    useEffect(() => {
                    ...
                    <div className='EAside2'>
                        <div>
                            ...
                            <div className='ENavbar1' style={{ display: "flex", flexDirection: "column", alignItems: "center" }}>
                                <div onClick={() => verificationStatus.isVerified && setActiveTab('Dashboard')} className={activetab === 'Dashboard' ? "Active1" : 'Navbox1'} >
                                ...
                                <div onClick={() => verificationStatus.isVerified && setActiveTab('Post a Job')} className={activetab === 'Post a Job' ? "Active1" : 'Navbox1'} >
                                ...
                                <div onClick={() => verificationStatus.isVerified && setActiveTab('Billing')} className={activetab === 'Billing' ? "Active1" : 'Navbox1'} >
                                    {activetab === 'Billing' ? <img src={BillingAct} height={15} width={15} alt="Billing" /> : <img src={Billing} height={15} width={15} alt="Billing" />}
                                </div>
                                <div onClick={() => setActiveTab('My Profile')} className={activetab === 'My Profile' ? "Active1" : 'Navbox1'} >
                                    {activetab === 'My Profile' ? <img src={ProfileAct} height={15} width={15} alt="My Profile" /> : <img src={Profile} height={15} width={15} alt="My Profile" />}
                                </div>
                                <div onClick={() => setShowLogoutModal(true)} className={activetab === 'Logout' ? "Active1" : 'Navbox1'} style={{ cursor: 'pointer' }}>
                                    {activetab === 'Logout' ? <img src={LogoutAct} height={15} width={15} alt="Logout" /> : <img src={Logout} height={15} width={15} alt="Logout" />}
                                </div>
                            </div>
                        </div>
